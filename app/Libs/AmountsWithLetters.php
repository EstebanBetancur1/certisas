...
/*
  AmountsWithLetters.php — ProInf.net — nov-2009, ago-2011
 
  AmountsWithLetters sirve para expresar una serie de cifras en letras.
  A modo de ejemplo convierte "22"> en "veintidós".
  Puede convertir un número entre una y ciento veintiséis cifras como máximo.
 
  Ejemplos de uso:
    AmountsWithLetters::convertirEurosEnLetras(22.34) --> "veintidós euros con treinta y cuatro céntimos"
    AmountsWithLetters::convertirNumeroEnLetras("35,67") --> "treinta y cinco con sesenta y siete"
...
class AmountsWithLetters {
  ...
  */
  public static function convertirAmountsWithLetters($cifras, $genero='neutro', $separadorGruposSeisCifras=null) {
  ...
  public static function convertirAmountsWithLettersMasculinas($cifras) {
    return self::convertirAmountsWithLetters($cifras, "masculino");
  }
 
  public static function convertirAmountsWithLettersFemeninas($cifras) {
    return self::convertirAmountsWithLetters($cifras, "femenino");
  }
  ...
  */
  ...
  /*
    ...
    Ejemplos:
      AmountsWithLetters::convertirEurosEnLetras("44276598801,2",2) --> "cuatrocientos noventa y ocho mil un euros con veinte céntimos"
      AmountsWithLetters::convertirEurosEnLetras(85009) --> "ochenta y cinco mil nueve euros"
      AmountsWithLetters::convertirEurosEnLetras(10200.35) --> "diez mil doscientos euros con treinta y cinco céntimos"
  */
  ...
  /*
    ...
    Ejemplos: AmountsWithLetters::formatearCifras("-4739249,2") --> "-4_739.249,2"
   */
  ...
  */
  private static function procesarEnLetras($cifras, $palabraSingular, $palabraPlural, $esFemenina) {
    ...
    // Letras
    $letras = self::convertirAmountsWithLetters($cifras, $genero);
